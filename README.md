...
source .venv/bin/activate
mkdir myTest
./ploidyNGS.py --out myTest/DataTestPloidy2.tab --bam test_data/HaploidGenome/Ploidy1.bowtie2.sorted.bam 
```
...
Compare your file DataTestPloidy2.tab_depth100.tab.PloidyNGS.pdf is should be pretty similar to test_data/ploidyNGS_results/DataTestPloidy1.tab.ExplorePloidy.png
